 ...
 * @author ralph
 */
public class AdminImpDao implements UtilisateurDao {
    ...
    public List<Utilisateur> findAll() {
        ...
        try {
            ...
            Logger.getLogger(AdminImpDao.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public boolean create(Utilisateur utilisateur) {
        ...
        try {
            ...
            Logger.getLogger(AdminImpDao.class.getName()).log(Level.SEVERE, null, e);
        }
